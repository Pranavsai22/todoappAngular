...
export class ProfileComponent implements OnInit {
  ...
  apiUrl = 'https://todoapp-be-n16d.onrender.com/api/todos/getuser'; // API endpoint to fetch user details
  delUrl= 'https://todoapp-be-n16d.onrender.com/api/todos/deleteuser'
